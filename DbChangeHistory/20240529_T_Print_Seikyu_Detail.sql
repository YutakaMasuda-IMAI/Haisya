...
/****** Object:  Table [dbo].[T_Print_Seikyu_Detail]    Script Date: 2024/05/29 13:20:43 ******/
SET ANSI_NULLS ON
GO
...
DROP TABLE [dbo].[T_Print_Seikyu_Detail]
GO
...
CREATE TABLE [dbo].[T_Print_Seikyu_Detail](
	...
	[FROM_DATE] [date] NULL,
	[TO_DATE] [date] NULL,
 CONSTRAINT [PK_T_Print_Seikyu_Detail_1] PRIMARY KEY CLUSTERED 
(
	[Print_Seikyu_ID] ASC,
	[Data_Kubun] ASC,
	[Data_Sort] ASC
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'1：ヘッダー、2：入金、３：案件明細' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'T_Print_Seikyu_Detail', @level2type=N'COLUMN',@level2name=N'Data_Kubun'
GO
