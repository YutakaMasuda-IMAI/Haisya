...
/****** Object:  Table [dbo].[T_Uriage_Shiharai]    Script Date: 2024/05/28 11:59:23 ******/
SET ANSI_NULLS ON
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'’P‰¿' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'T_Uriage_Shiharai', @level2type=N'COLUMN',@level2name=N'ShiharaiPrice'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ŒvŽZ‰^’À' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'T_Uriage_Shiharai', @level2type=N'COLUMN',@level2name=N'WarimashiPrice'
GO
