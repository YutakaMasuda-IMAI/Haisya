...
/****** Object:  Table [dbo].[T_Print_Shitabarai]    Script Date: 2024/05/30 18:20:12 ******/
SET ANSI_NULLS ON
GO
...
DROP TABLE [dbo].[T_Print_Shitabarai]
GO

CREATE TABLE [dbo].[T_Print_Shitabarai](
	[Print_Shitabarai_ID] [int] IDENTITY(1,1) NOT NULL,
	[Yosya_ID] [int] NOT NULL,
	[Shime_Date] [date] NOT NULL,
	[Check_Shitabarai_ID] [int] NOT NULL,
	[Shitabarai_ID] [int] NOT NULL,
	...
	[Shiharai_Date] [nvarchar](10) NULL,
	[‘OŒc] [decimal](18, 0) NULL,
	[“–Œx•¥Šz] [decimal](18, 0) NULL,
	[ŒJ‰z‹àŠz] [decimal](18, 0) NULL,
	[‰ÛÅx•¥‹àŠz] [decimal](18, 0) NULL,
	[”ñ‰ÛÅx•¥‹àŠz] [decimal](18, 0) NULL,
	[¡‰ñx•¥‹àŠz] [decimal](18, 0) NULL,
	[Á”ïÅŠz] [decimal](18, 0) NULL,
	[Åx•¥‹àŠz] [decimal](18, 0) NULL,
	[¡‰ñx•¥Šz] [decimal](18, 0) NULL,
	[Œ»‹àx•¥Šz] [decimal](18, 0) NULL,
	[¬Øèx•¥Šz] [decimal](18, 0) NULL,
	[Ux•¥Šz] [decimal](18, 0) NULL,
	[èŒ`x•¥Šz] [decimal](18, 0) NULL,
 ...
 CONSTRAINT [PK_T_Print_Shitabarai_1] PRIMARY KEY CLUSTERED 
(
...
ALTER TABLE [dbo].[T_Print_Shitabarai] ADD  CONSTRAINT [DF_T_Print_Shitabarai_Print_Pattern]  DEFAULT ((0)) FOR [Print_Pattern]
GO

ALTER TABLE [dbo].[T_Print_Shitabarai] ADD  CONSTRAINT [DF_T_Print_Shitabarai_UP_DATE]  DEFAULT (getdate()) FOR [UP_DATE]
GO
