...
namespace RenkeiDB.Data
{
    ...
    public partial class ApplicationDbContext : DbContext
    {
        ...
        public virtual DbSet<SP_ResultForInt> SP_T_Share_Syaryos { get; set; }
        public virtual DbSet<SP_ResultForInt> SP_T_Share_Luggages { get; set; }
        public virtual DbSet<SP_ResultForString> SP_T_Share_Nos { get; set; }
        public virtual DbSet<SP_ResultForInt> SP_T_Renkei_Anken { get; set; }
        public virtual DbSet<SP_ResultForString> SP_T_Renkei_Anken_No { get; set; }
...
/*#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.*/
                optionsBuilder.UseSqlServer("Data Source=IMAI-SRV\\TIGER;Database=Renkei;user id=sa;password=Imai;Connection Timeout=300;");
            }
        }
