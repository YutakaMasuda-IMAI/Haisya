...
public partial class ApplicationDbContext : DbContext
{
    ...
    public virtual DbSet<T_Nippou_Anken> T_Nippou_Ankens { get; set; }

    public virtual DbSet<T_Nippou_Anken_Degitako> T_Nippou_Anken_Degitakos { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=IMAI-SRV-DB\\SQLEXPRESS;Database=Haisya;user id=sa;password=Imaiunso00;Connection Timeout=300;Trusted_Connection=False;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<B_Seikyu>(entity =>
        {
            entity.HasKey(e => e.Bak_Seikyu_ID).HasName("PK_B_Seikyu_1");
        ...
        {
            entity.HasKey(e => new { e.Bak_Seikyu_ID, e.Data_Kubun, e.Data_Sort }).HasName("PK_B_Seikyu_Detail_1");
        ...
        {
            entity.HasKey(e => e.Bak_Uriage_Month_ID).HasName("PK_B_Uriage_Month_1");
        ...
        {
            entity.HasKey(e => new { e.Bak_Uriage_Month_ID, e.Data_Kubun, e.Data_Sort }).HasName("PK_B_Uriage_Month_Detail_1");
        ...
        {
            entity.HasKey(e => e.Komoku_ID).HasName("PK_M_Anken_Excharge_1");
        ...
        {
            entity.Property(e => e.Insert_User).HasDefaultValue(0);
            entity.Property(e => e.Update_User).HasDefaultValue(0);
        });
        ...
        {
            entity.HasKey(e => new { e.Branch_ID, e.Company_ID }).HasName("PK_M_ComopanyBranch");
        ...
        {
            entity.HasKey(e => e.Driver_ID).HasName("PK_M_CompanyDriver_1");
        ...
        {
            entity.HasKey(e => e.DriverSyaryo_ID).HasName("PK_[M_CompanyDriver_Syaryo");

            entity.Property(e => e.Start_Date).HasDefaultValue(new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified));
            entity.Property(e => e.SyaryoManagement_ID1).HasDefaultValue(0);
        });
        ...
        {
            entity.HasKey(e => e.User_ID).HasName("PK_M_CompanyUser_1");
        ...
        {
            entity.Property(e => e.Group_Kubun).HasDefaultValue(1);
            entity.Property(e => e.UP_DATE).HasDefaultValueSql("(getdate())");
        });

        modelBuilder.Entity<M_CompanyUser_GroupUser>(entity =>
        {
            entity.HasKey(e => new { e.Group_ID, e.User_ID }).HasName("PK_M_CompanyUser_Group_User");
        });
        ...
        {
            entity.HasKey(e => e.Customer_Branch_ID).HasName("PK_M_Customer_Branch_1");

            entity.Property(e => e.Collection_Day).HasComment("回収日");
            entity.Property(e => e.Collection_Sight).HasComment("回収サイト");
            entity.Property(e => e.Customer_Branch_Code_Trac_Tokuisaki).HasDefaultValue(0);
            entity.Property(e => e.Customer_Branch_Code_Trac_Yosyasaki).HasDefaultValue(0);
            entity.Property(e => e.Customer_Branch_Number).HasComment("法人番号");
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
        ...
        {
            entity.HasKey(e => e.Customer_Driver_ID).HasName("PK_M_Customer_Driver_1");
        ...
        {
            entity.HasKey(e => e.Customer_DriverSyaryo_ID).HasName("PK_[M_Customer_Driver_Syaryo");
        ...
        {
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.SeikyuKubun).HasDefaultValue(0);
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
        });
        ...
        modelBuilder.Entity<M_Customer_Shiharai_Calc>(entity =>
        {
            ...
            entity.Property(e => e.Warimashi1_Visible).HasDefaultValue(false);
            entity.Property(e => e.Warimashi2_Calc).HasDefaultValueSql("((0))");
            entity.Property(e => e.Warimashi2_Visible).HasDefaultValue(false);
            entity.Property(e => e.Warimashi3_Calc).HasDefaultValueSql("((0))");
            entity.Property(e => e.Warimashi3_Visible).HasDefaultValue(false);
            entity.Property(e => e.Warimashi4_Calc).HasDefaultValueSql("((0))");
            entity.Property(e => e.Warimashi4_Visible).HasDefaultValue(false);
            entity.Property(e => e.Warimashi5_Calc).HasDefaultValueSql("((0))");
            entity.Property(e => e.Warimashi5_Visible).HasDefaultValue(false);
        });

        modelBuilder.Entity<M_Customer_Tantou>(entity =>
        {
            entity.HasKey(e => e.Tantou_ID).HasName("PK_M_Customer_Tantou_1");
        ...
        {
            entity.HasKey(e => new { e.Customer_ID, e.Group_ID }).HasName("PK_M_Customer_Tantou");
        });
        ...
        {
            entity.HasKey(e => e.Customer_Branch_ID).HasName("PK_M_Customer_Seikyu");
        ...
        {
            entity.HasKey(e => new { e.Area, e.SyasyuSize, e.From_Distance }).HasName("PKM_DefaultMoney");

            entity.Property(e => e.AdditionAmount).HasDefaultValue(0m);
            entity.Property(e => e.Amount).HasDefaultValue(0m);
        });

        modelBuilder.Entity<M_DefaultMoney_WaitTimeForArea>(entity =>
        {
            entity.HasKey(e => new { e.SyasyuSize, e.Area }).HasName("PK_M_DefaultMoney_WaitTimeForEria");
        });

        modelBuilder.Entity<M_DefaultMoney_WaitTimeForCompany>(entity =>
        {
            entity.HasKey(e => new { e.Company_ID, e.Area, e.SyasyuSize }).HasName("PK_M_DefaultMoney_WaitTimeForCompany_1");
        });
        ...
        {
            entity.HasKey(e => new { e.Company_ID, e.Branch_ID, e.FromDate }).HasName("PK_M_FuelCost_1");
        });
        ...
        {
            entity.Property(e => e.BenefitsCosts).HasDefaultValue(0.0);
            entity.Property(e => e.IndirectCosts).HasDefaultValue(0.0);
        });
        ...
        {
            entity.Property(e => e.Branch_ID).HasDefaultValue(0);
            entity.Property(e => e.Company_ID).HasDefaultValue(0);
        ...
        {
            entity.Property(e => e.Branch_ID).HasDefaultValue(0);
            entity.Property(e => e.Comany_ID).HasDefaultValue(0);
        });
        ...
        {
            entity.Property(e => e.AVG_FUEL_COSTS).HasDefaultValue(0.0);
            entity.Property(e => e.CAR_GROSS_WEIGHT).HasDefaultValue(0.0);
            entity.Property(e => e.CAR_WEIGHT).HasDefaultValue(0.0);
            entity.Property(e => e.HEIGHT).HasDefaultValue(0.0);
            entity.Property(e => e.LONG).HasDefaultValue(0.0);
            entity.Property(e => e.MAX_LOAD_CAPA).HasDefaultValue(0.0);
            entity.Property(e => e.UP_DATE).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.WIDTH).HasDefaultValue(0.0);
        });
        ...
        {
            entity.HasKey(e => e.SyaryoManagement_ID).HasName("PK_M_車両管理台帳");

            entity.Property(e => e.Syaryo_ID).HasDefaultValue(0);
            entity.Property(e => e.Syaryo_Price).HasDefaultValue(0m);
        });
        ...
        {
            entity.Property(e => e.Del_Flg).HasDefaultValue(0);
        ...
        {
            entity.Property(e => e.Daisuu).HasDefaultValue(0);
            entity.Property(e => e.HaisyaPlanKubun).HasComment("0:未定、1:自車、2:傭車、3:専属庸車、4:専属、5:自社専任");
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.NumberCommLimitKubun).HasDefaultValue(0);
            entity.Property(e => e.RouteType).HasDefaultValue(0);
            entity.Property(e => e.Route_BreakTime).HasDefaultValue(0);
            entity.Property(e => e.Route_RestTime).HasDefaultValue(0);
            entity.Property(e => e.Route_TotalDays).HasDefaultValue(0);
            entity.Property(e => e.SeikyuKubun).HasDefaultValue(0);
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
        });
        ...
        {
            entity.Property(e => e.Equipment_Count).HasDefaultValue(0.0);
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
        });
        ...
        {
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.Luggage_Count).HasDefaultValue(0.0);
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
        });
        ...
        {
            entity.HasKey(e => new { e.Anken_ID, e.Anken_Order, e.Kokyaku_Order }).HasName("PK_T_Anken_OyaKokyaku_1");
        });

        modelBuilder.Entity<T_Anken_Point>(entity =>
        {
            entity.Property(e => e.FlgGenchiKakunin).HasDefaultValue(false);
            entity.Property(e => e.Insert_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.Insert_User).HasDefaultValue(0);
            entity.Property(e => e.TollDisplayHeight).HasDefaultValue(0.0);
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
            entity.Property(e => e.Update_User).HasDefaultValue(0);
        });
        ...
        {
            entity.HasKey(e => new { e.Anken_ID, e.Anken_Order }).HasName("PK_T_Anken_Remarks");
        });

        modelBuilder.Entity<T_Anken_Riyounso>(entity =>
        {
            entity.Property(e => e.AdvancesPaid).HasDefaultValue(0m);
            entity.Property(e => e.Daisuu).HasDefaultValue(0);
            entity.Property(e => e.EigyoID).HasDefaultValue(0);
            entity.Property(e => e.GrossAmount).HasDefaultValue(0m);
            entity.Property(e => e.Insert_User).HasDefaultValue(0);
            entity.Property(e => e.KokyakuId).HasDefaultValue(0);
            entity.Property(e => e.KokyakuTantouId).HasDefaultValue(0);
            entity.Property(e => e.PaymentAmount).HasDefaultValue(0m);
            entity.Property(e => e.SeikyuKubun).HasDefaultValue(0);
            entity.Property(e => e.TantouID).HasDefaultValue(0);
            entity.Property(e => e.Toll).HasDefaultValue(0m);
            entity.Property(e => e.Update_User).HasDefaultValue(0);
            entity.Property(e => e.YosyaDriverID).HasDefaultValue(0);
        });
        ...
        {
            entity.ToTable("T_Haisya", tb => tb.HasComment(""));
        ...
        modelBuilder.Entity<T_Nippou_Anken>(entity =>
        {
        ...
        {
            entity.HasKey(e => e.Nippou_Approval_ID).HasName("PK_T_Nippou_approval");
        ...
        modelBuilder.Entity<T_Print_Parameter>(entity =>
        {
            ...
            entity.Property(e => e.Tokun).IsFixedLength();
            entity.Property(e => e.Update_Datetime).HasDefaultValueSql("(getdate())");
        });
        ...
        {
            entity.HasKey(e => e.Print_Seikyu_ID).HasName("PK_T_Print_Seikyu_1");
        ...
        {
            entity.HasKey(e => new { e.Print_Seikyu_ID, e.Data_Kubun, e.Data_Sort }).HasName("PK_T_Print_Seikyu_Detail_1");

            entity.Property(e => e.Data_Kubun).HasComment("");
            entity.Property(e => e.Nyukin_ID).HasDefaultValue(0);
            entity.Property(e => e.Uriage_Unchin_ID).HasDefaultValue(0);
        });

        modelBuilder.Entity<T_Print_Shitabarai>(entity =>
        {
            entity.HasKey(e => e.Print_Shitabarai_ID).HasName("PK_T_Print_Shitabarai_1");
        ...
        {
            entity.HasKey(e => new { e.Print_Shitabarai_ID, e.Data_Kubun, e.Data_Sort }).HasName("PK_T_Print_Shitabarai_Detail_1");
        ...
        {
            entity.HasKey(e => e.Uriage_Shiharai_ID).HasName("PK_T_Uriage_Shiharai");
        ...
        modelBuilder.Entity<V_HaisyaDataList_old>(entity =>
        {
            ...
            entity.Property(e => e.AnkenStatusDisplay).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.AnkenStep).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Anken_No).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Customer_Name_Abbr).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            ...
            entity.Property(e => e.End_Lat).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.End_Lng).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            ...
            entity.Property(e => e.OroshiTaskTime).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Remarks).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Root_Ferry).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Root_Regulation).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Root_Twouturn).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            ...
            entity.Property(e => e.Start_Lat).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            entity.Property(e => e.Start_Lng).UseCollation("SQL_Latin1_General_CP1_CI_AS");
            ...
            entity.Property(e => e.TsumiTaskTime).UseCollation("SQL_Latin1_General_CP1_CI_AS");
        ...
        {
            entity.HasKey(e => e.コード).HasName("PK_M_Tokuisaki_SeikyuTantou");
