...
[Keyless]
public partial class V_HaisyaDataList_old
{
    ...
    [Required]
    [StringLength(20)]
    public string FILL_SYABAN { get; set; }
    ...
    public int? Yosya_Display1 { get; set; }

    public int? Yosya_Display2 { get; set; }

    public int? Yosya_Display3 { get; set; }
