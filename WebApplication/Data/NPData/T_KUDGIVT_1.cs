...
{
    [Table("T_KUDGIVT_1")]
    [Index(nameof(乗務員CD), nameof(開始日時), Name = "IX_T_KUDGIVT_1a")]
    [Index(nameof(運行NO), Name = "IX_T_KUDGIVT_2a")]
    [Index(nameof(取り込み日), nameof(取り込みID), Name = "IX_T_KUDGIVTa", IsUnique = true)]
    public partial class T_KUDGIVT_1
    {
        [Key]
