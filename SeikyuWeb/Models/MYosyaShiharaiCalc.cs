...
{
    /// <summary>
    /// MYosyaShiharaiCalc クラスは、顧客の支払計算情報を管理します。
    /// </summary>
    public partial class MYosyaShiharaiCalc
    {
        /// <summary>
        /// 支店ID
        /// </summary>
        ...
        /// 支払運賃名
        /// </summary>
        public string ShiharaiUnchinName { get; set; }
        /// <summary>
        /// 立替金名
        /// </summary>
        ...
        /// 支払合計名
        /// </summary>
        public string ShiharaiTotalName { get; set; }
        /// <summary>
        /// 割増1表示
        /// </summary>
        ...
        /// 支払合計計算
        /// </summary>
        public string ShiharaiTotalCalc { get; set; }
    }
}
