...
using System.Web;
using static PartnerWeb.Models.AnkenModel;
...
namespace PartnerWeb.API.WebApp
{
    class AnkenDataApi : BaseHttpClient
    {
        ...
        public async Task<T_Anken_Local> AddNewAnkenData(AnkenDataModelDto ankenDataModelDto)
        {
            ...
            string url = _baseUrl + string.Format("AnkenData/AddNewAnkenData?jsonString={0}", "A");
            HttpRequestMessage request = this.CreateRequest(HttpMethod.Get, url);
            request.Content = content;

            string resBodyStr;

            T_Anken_Local result;
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<T_Anken_Local>(resBodyStr);
        ...
        public async Task<UpdateAnkenDataDto> UpdateAnkenData(AnkenDataModelDto ankenDataModelDto)
        {
            ...
            string url = _baseUrl + string.Format("AnkenData/UpdateAnkenData?jsonString={0}", "A");
            HttpRequestMessage request = this.CreateRequest(HttpMethod.Get, url);
            request.Content = content;
        ...
        public async Task<IEnumerable<V_AnkenDataList_Local>> GetAnkenDataList(string targetDate, string targetDateFrom, string targetDateTo,
                                                                            int iCompanyID, int branchID = 0)
        {

            string url = _baseUrl + string.Format("AnkenData/GetAnkenDataList?CcompanyID={0}&branchID={1}", iCompanyID, branchID);
            ...
            IEnumerable<V_AnkenDataList_Local> result;
            ...
            try
            {
                ...
                result = JsonConvert.DeserializeObject<IEnumerable<V_AnkenDataList_Local>>(resBodyStr);
        ...
        public async Task<AnkenDataModelDto> GetAnkenData(int AnkenId)
        {
            ...
            string url = _baseUrl + string.Format("AnkenData/GetAnkenData?AnkenId={0}", AnkenId);
            HttpRequestMessage request = this.CreateRequest(HttpMethod.Get, url);

            string resBodyStr;

            AnkenDataModelDto resultList;
            ...
            try
            {
                ...
                resultList = JsonConvert.DeserializeObject<AnkenDataModelDto>(resBodyStr);
                                                        ...
                                                        string OroshiTime = "00:00")
        {
            ...
            string url = _baseUrl + string.Format("Anken/GetDriveRouteListEx?CompanyID={0}", iCompanyID);
            ...
            url += string.Format("&cardetailinfo={0}", regulationtype);
            url += string.Format("&tolltype={0}", tolltype);
            url += string.Format("&smartic={0}", smartic);
            url += string.Format("&regulation={0}", timerestriction);
